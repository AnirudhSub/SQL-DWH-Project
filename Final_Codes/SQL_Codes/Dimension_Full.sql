...
SELECT * FROM [Staging].[S_CDW_SAPP_SUPPLIER]S*/

	IF OBJECT_ID(N'[DW].[CDW_SAPP_D_SUPPLIER]' , N'U') IS NULL
	BEGIN
...
/*SELECT * FROM [DW].[CDW_SAPP_D_TIME]*/
	...
	IF OBJECT_ID(N'[DW].[CDW_SAPP_D_TIME]' , N'U') IS NULL
	BEGIN
...
----------------------------------------------------------BRANCH DIMENSION-------------------------------------------------------------
	IF OBJECT_ID(N'[DW].[CDW_SAPP_D_BRANCH]' , N'U') IS NULL
	BEGIN
	...
	OR TRG.SOURCE_DATA != SRC.SOURCE_DATA )
