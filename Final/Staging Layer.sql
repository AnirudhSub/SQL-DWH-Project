----------------------------------------------------UPDATED LANDING TABLES--------------------------------------------------------
exec sp_help '[Landing].[L_CDW_SAPP_CUSTOMER]';
SELECT * FROM [Landing].[L_CDW_SAPP_BRANCH]
SELECT * FROM [Landing].[L_CDW_SAPP_D_CUSTOMER]
SELECT * FROM [Landing].[U_CDW_SAPP_D_SUPPLIER];
SELECT * FROM [Landing].[L_CDW_SAPP_PRODUCT]
SELECT * FROM [Landing].[L_CDW_SAPP_D_CALENDAR]
SELECT * FROM [Landing].[L_CDW_SAPP_F_SALES] 
...
DROP PROCEDURE IF EXISTS CUSTOMER_STAGING
...
DROP PROCEDURE SUPPLIER_STAGING

CREATE PROCEDURE SUPPLIER_STAGING
AS BEGIN
...
FROM [Landing].[L_CDW_SAPP_BRANCH] WHERE 1=2;

CREATE PROCEDURE BRANCH_STAGING 
AS 
BEGIN
...
DROP PROCEDURE TIME_STAGING
CREATE PROCEDURE TIME_STAGING
AS 
BEGIN
...
DROP PROCEDURE IF EXISTS PRODUCT_STAGING
CREATE PROCEDURE PRODUCT_STAGING
AS
BEGIN
